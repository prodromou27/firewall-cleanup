...
CATEGORY_META: dict = {
    ...
    "rdp_exposed":        "RDP Exposed to Untrusted Sources",
    "ssh_exposed":        "SSH Exposed to Untrusted Sources",
    "database_exposed":   "Database Exposed to Untrusted Sources",
    "cleartext_service":  "Cleartext Protocol Rules",
    "inbound_from_internet": "Direct Inbound Internet Exposure",
    "lateral_movement_risk": "Lateral Movement Risk Rules",
    "mergeable_rules":    "Rule Consolidation Candidates",
...
CATEGORY_SHEET_NAMES: dict = {
    ...
    "inbound_from_internet": "Inbound Internet Exposure",
    "lateral_movement_risk": "Lateral Movement",
