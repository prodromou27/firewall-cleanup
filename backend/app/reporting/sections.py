...
SECTION_CATALOG = [
    ...
    {"key": "application_control","name": "Application Control Findings","type": T_FINDINGS,"group": "Findings","default": False,"finding_types": ["rule_without_app_controls", "palo_alto_port_based_rule_candidate", "risky_application_allowed", "application_any", "url_category_risk", "application_data_unavailable", "application_analysis_not_supported_for_vendor", "fortigate_security_profile_gap", "checkpoint_app_url_layer_issue"]},
    {"key": "analysis_quality", "name": "Analysis Quality & Data Availability","type": T_FINDINGS,"group": "Findings","default": False,"finding_types": ["detector_prerequisites_unmet", "import_quality", "object_usage_unknown"]},
    {"key": "unused_objects",    "name": "Unattached Objects",    "type": T_FINDINGS, "group": "Objects",       "default": False,"finding_types": ["unattached_object", "unused_object", "object_usage_unknown"]},
    {"key": "duplicate_objects", "name": "Duplicate Objects",     "type": T_FINDINGS, "group": "Objects",       "default": False,"finding_types": ["duplicate_object"]},
    {"key": "overlapping_objects","name": "Overlapping Objects",  "type": T_FINDINGS, "group": "Objects",       "default": False,"finding_types": ["overlapping_object", "broad_network", "large_group", "empty_group", "service_range"]},
...
FINDING_CATEGORIES = [
    ...
    ("detector_prerequisites_unmet", "Detectors Limited by Missing Data"),
