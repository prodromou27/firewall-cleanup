    ...
    <div className="fixed inset-0 z-50 flex justify-end" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="px-6 py-4 border-b border-gray-100">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-1.5">
              <Cpu className="w-3 h-3" /> Version Intelligence
            </h3>
            {!verData ? (
              <button onClick={loadVersionIntel} disabled={verLoading}
                ...
                <RefreshCw className={clsx('w-3 h-3', verLoading && 'animate-spin')} />
                {verLoading ? 'Checking…' : 'Check version against catalog'}
              </button>
            ) : (
              <div className="space-y-2">
                    ...
                    <div key={i} className="bg-gray-50 border border-gray-200 rounded-lg p-2.5">
                      <div className="flex items-center justify-between mb-0.5">
                        ...
                        <span className={clsx('text-[10px] font-bold px-1.5 py-0.5 rounded',
                          ...
                          f.severity === 'Critical' ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-600')}>{f.severity}</span>
                      </div>
